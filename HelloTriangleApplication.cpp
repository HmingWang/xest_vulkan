...
VkSurfaceFormatKHR
HelloTriangleApplication::chooseSwapChainSurfaceFormat(const std::vector<VkSurfaceFormatKHR> &availableFormats) {
...
VkPresentModeKHR
HelloTriangleApplication::chooseSwapChainPresentMode(const std::vector<VkPresentModeKHR> &availablePresentModes) {
...
void HelloTriangleApplication::createSwapChain() {
    ...
    createInfo.compositeAlpha=VK_COMPOSITE_ALPHA_OPAQUE_BIT_KHR;//与其他窗口混合
